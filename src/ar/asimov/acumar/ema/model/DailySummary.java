...
@IdClass(DailySummary.PrimaryKey.class)
@Entity
@Table(name="ta_ams_daily_summary")
public class DailySummary implements Serializable {
	...
	@Column(name="min_sunlihgt")
	private Short minSunlinght;
	@Column(name="dailySolarEnergy")
