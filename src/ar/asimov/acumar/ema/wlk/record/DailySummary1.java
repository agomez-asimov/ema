...
public final class DailySummary1 extends Struct{

	
	/**
	 * Safety check to know we are reading the correct record type
	 * For Daily Summary 1 record dataType = 2
	 */
	...
	/**
	 * Highest outside temperature of the day represented in tenths of a degree F
	 */
	public final Signed16 hiOutTemp = new Signed16(); 
	/**
	 * Lowest outside temperature of the day represented in tenths of a degree F
	 */
	public final Signed16 lowOutTemp = new Signed16();
	/**
	 * Highest inside temperature of the day represented in tenths of a degree F
	 */
	public final Signed16 hiInTemp = new Signed16();
	/**
	 * Lowest inside temperature of the day represented in tenths of a degree F
	 */
	public final Signed16 lowInTemp = new Signed16();
	/**
	 * Average outside temperature of the day represented in tenths of a degree F (integrated over the day)
	 */
	public final Signed16 avgOutTemp = new Signed16();
	/**
	 * Average inside temperature of the day represented in tenths of a degree F (integrated over the day)
	 */
	public final Signed16 avgInTemp = new Signed16();
	/**
	 * Highest wind chill of the day represented in tenths of a degree F
	 */
	public final Signed16 hiChill = new Signed16();
	/**
	 * Lowest wind chill of the day represented in tenths of a degree F
	 */
	public final Signed16 lowChill = new Signed16();
	/**
	 * Highest dewpoint of the day represented in tenths of a degree F
	 */
	public final Signed16 hiDew = new Signed16();
	/**
	 * Lowest dewpoint of the day represented in tenths of a degree F
	 */
	public final Signed16 lowDew = new Signed16();
	/**
	 * Average wind chill of the day represented in tenths of a degree F
	 */
	public final Signed16 avgChill = new Signed16();
	/**
	 * Average dewpoint of the day represented in tenths of a degree F
	 */
	public final Signed16 avgDew = new Signed16();
	/**
	 * Highest outside humidity of the day represented in tenths of a percent
	 */
	public final Signed16 hiOutHum = new Signed16();
	/**
	 * Lowest outside humidity of the day represented in tenths of a percent
	 */
	public final Signed16 lowOutHum = new Signed16();
	/**
	 * Highest inside humidity of the day represented in tenths of a percent	
	 */
	public final Signed16 hiInHum = new Signed16();
	/**
	 * Lowest inside humidity of the day represented in tenths of a percent
	 */
	public final Signed16 lowInHum = new Signed16();
	/**
	 * Average outside humidity of the day represented in tenths of a percent
	 */
	public final Signed16 avgOutHum = new Signed16();
	/**
	 * Highest pressure of the day represented in thousandths of an inch Hg
	 */
	public final Signed16 hiBar = new Signed16();
	/**
	 * Lowest pressure of the day represented in thousandths of an inch Hg
	 */
	public final Signed16 lowBar = new Signed16();
	/**
	 * Average pressure of the day represented in thousandths of an inch Hg
	 */
	public final Signed16 avgBar = new Signed16();
	
	/**
	 * Highest wind speed of the day represented in tenths of an MPH. 
	 */
	public final Signed16 hiSpeed = new Signed16();
	/**
	 * Average wind speed of the day represented in tenths of a MPH 
	 */
	public final Signed16 avgSpeed = new Signed16();
	/**
	 * Wind run of the day represented in 1/10'th of a mile
	 */
	public final Signed16 dailyWindRunTotal = new Signed16();
	/**
	 * Highest average 10min wind speed record in tenths of a MPH
	 */
	public final Signed16 hi10MinSpeed = new Signed16();
	
	/**
	 * Direction of the highest wind speed represented in direction code (0-15, 255)
	 */
	public final Unsigned8 dirHiSpeed = new Unsigned8();
	/**
	 * Direction of the highest average 10min speed represented in direction code (0-15, 255)
	 */
	public final Unsigned8 hi10MinDir = new Unsigned8();
	/**
	 * The daily rain total represented in 1/1000'th of an inch
	 */
	...
	/**
	 * The daily UV dose represented in 1/10'th of a standard MED
	 */
	public final Signed16 dailyUVDose = new Signed16();
	/**
	 * The UV index represented in tenth of a UV Index
	 */
	 ...
	 * Time of High UV                   17
	 */
	public final Unsigned8[] timeValues = array(new Unsigned8[27]);// space for 18 time values (see below)\par
